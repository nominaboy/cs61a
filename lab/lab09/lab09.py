...
class Keyboard:
    ...
    def typing(self, typing_input):
        ...
        output_str = ''
        for k in typing_input:
            output_str += self.press(k)
        return output_str
...
def make_advanced_counter_maker():
    ...
    def make_counter():
        ...
        def counter_helper(req_str):
            ...
            if req_str == 'global-reset':
                global_counter = 0
            if req_str == 'global-count':
                global_counter += 1
...
def shuffle(cards):
    ...
    for i in range(len(cards)):
        if i % 2 == 0:
            ...
            shuffled.append(cards[i // 2 + half])
    return shuffled
